...
def plot_loss_acc_curve(loss_train, loss_val, acc_val, rounds, args):
        ...
        savePath = os.path.join(savePath,'RoundNum{}_RoundDuration{}_LocalTrainDelay{}_LocalIterNum{}_LocalBatchSize{}_LR{}.png'.format(rounds, args.round_duration, args.local_train_time, args.local_iter, args.local_bs, args.lr))
